...
/**
 * Runs the browser API against the S3 storage backend.
 */
...
class S3BrowserControllerTest {
	...
	static void s3Properties(DynamicPropertyRegistry registry) {
		S3TestSupport.registerS3Properties(registry, "browser");
	}
	...
	@Test
	void browseRepository_shouldListEntries() throws Exception {
	...
	@Test
	void getFileInfo_shouldReturnChecksums() throws Exception {
